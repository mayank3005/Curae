    ...
    <>
      ...
      <div className="appointment-bar-top mt-3 d-flex align-items-center">
        <div className="our-doctors-content">
          <h1 className=' display-3'>Apply As Doctor</h1>
        </div>
      </div>
      <Form layout="vertical" onFinish={handleFinish} className="m-5 px-5 pb-5">
        ...
        <Row gutter={20}>
          ...
          <Col xs={24} md={24} lg={8}>
            <button className="btn btn-primary applydoc-form-btn" type="submit">
              Submit
            </button>
          </Col>
        </Row>
